\documentclass[10pt,spanish,letterpaper,oneside]{report}
...
\maketitle
<<opciones>>=
opts_chunk$set(concordance=TRUE, echo=FALSE, results='asis', dev=c('postscript','pdf'), fig.path='Figuras/')
@
\begin{dedication}
